...
import { createUserAccount, userSignIn, resetPassword, validateToken, generateResetToken, verifyUserAccount } from '../controllers/AuthController';
import {
...
authRouter.post('/verify_account', verifyUserAccount);
